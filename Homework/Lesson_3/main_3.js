...
for (let userStatusTrue of users) {

    if (userStatusTrue.status === true){

        console.log(userStatusTrue);
    }
}

//  – користувачів зі статусом false

for (let userStatusFalse of users) {

    if (userStatusFalse.status === false){

        console.log(userStatusFalse);
    }
}
